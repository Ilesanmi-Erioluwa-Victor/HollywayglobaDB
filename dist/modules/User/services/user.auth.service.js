...
exports.forgetPasswordToken = (0, utils_1.catchAsync)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const passwordReset = yield (0, models_1.forgetPasswordTokenM)(resetToken, expirationTime, user === null || user === void 0 ? void 0 : user.id);
...
exports.createAddress = (0, utils_1.catchAsync)(asyn(req, Request, res, Response, next, express_1.NextFunction));
{
}
;
